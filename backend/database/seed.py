...
SEED_COUPONS = [
    {"id": "c1", "code": "FESTIVE20", "discount_percent": 20.00, "max_discount": 15000.00, "min_order_value": 0.00},
    {"id": "c2", "code": "BRIDAL15", "discount_percent": 15.00, "max_discount": 10000.00, "min_order_value": 0.00},
    {"id": "c3", "code": "KIDSGIFT", "discount_percent": 0.00, "max_discount": 1000.00, "min_order_value": 5000.00},
    {"id": "c4", "code": "PREPAID500", "discount_percent": 0.00, "max_discount": 500.00, "min_order_value": 0.00},
    {"id": "c5", "code": "HERITAGE10", "discount_percent": 10.00, "max_discount": 3000.00, "min_order_value": 2999.00},
    {"id": "c6", "code": "WEDDING2026", "discount_percent": 15.00, "max_discount": 5000.00, "min_order_value": 15000.00},
    {"id": "c7", "code": "SRINIVASA5", "discount_percent": 5.00, "max_discount": 1000.00, "min_order_value": 1000.00}
]
...
def seed_all():
    ...
    if not existing_admin:
        ...
        execute_db(
            ...
            (admin_id, "admin", "admin@srinivasatextiles.com", hashed, "owner", "Srinivasa Textiles Master Admin", "+916381265149")
        )
    ...
    existing_reviews = query_db("SELECT COUNT(*) as count FROM reviews", one=True)
    count_reviews = existing_reviews["count"] if existing_reviews else 0
    if count_reviews == 0:
        execute_db(
            """INSERT INTO reviews (id, product_id, author, location, rating, title, comment, dept, softness_score, verified)
            VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)""",
            ("rev-1", "ST-KAN-001", "Meenakshi Sundaram", "Chennai, TN", 5, "Exquisite Bridal Korvai Saree", "The zari luster and pure mulberry silk fall are truly royal. Delivered with authentic Silk Mark certification.", "Women", 10, 1)
        )
        execute_db(
            """INSERT INTO reviews (id, product_id, author, location, rating, title, comment, dept, softness_score, verified)
            VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)""",
            ("rev-2", "ST-MEN-001", "Karthik Narayanan", "Bengaluru, KA", 5, "Magnificent Mulberry Silk Set", "Wore this for our family muhurtham. The comfort and pure silk sheen exceeded all expectations.", "Men", 9, 1)
        )
